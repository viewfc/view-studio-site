...
function App() {
  ...
  const appList = [
    ...
    { id: 8, name: 'IT Learning Hub', icon: '🌐', link: 'https://learnplaycreate-hub.lovable.app/' }, 
    { id: 9, name: 'Zero Waste School MTS', icon: '🏫', link: 'https://zero-waste-school-mts.lovable.app/' }, 


    // แอปที่เหลือ (ใส่ '#' ไว้ก่อนเพื่อให้เป็นสีเทา)
    { id: 15, name: 'AI ชุมชน', icon: '👥', link: '#' },
    { id: 16, name: 'แจ้งเหตุฉุกเฉิน AI', icon: '🚨', link: '#' },
    { id: 119, name: 'จัดการข้อมูลโรงเรียน', icon: '🏫', link: '#' }, 
